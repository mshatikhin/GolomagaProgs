$(document).ready(function (e) {
    var ed = $("#ed-4");	//ежемесяный доход
    var no = $("#no-4");	//налоговые отчисления
    var ap = $("#ap-4");	//арендная плата
    var svt = $("#svt-4");	//стоимость ввезенных товаров
    var zp = $("#zp-4");	//заработная плата работников
    var rt = $("#rt-4");	//расходы на транспортные услуги
    var pr = $("#pr-4");	//прочие расходы
    var pk = $("#pk-4");	//плата за комунальные услуги
    var pz = $("#pz-4");	//плата за кредит
    var itog1 = $("#itog1-4");	//чистая прибыль
    var nsm = $("#nsm-4");	//необходимая сумма на первый месяц
    var sums = $("#sums-4");	//общая сумма расходов
    var credit = $("#credit-4");	//кредит
    var ssn = $("#ssn-4");	//сумма средств в наличии
    var so = $("#so-4");	//стоимость оборудования
    var sr = $("#sr-4");	//стоимость рекламы
    var timeo = $("#timeo-4");	//срок окупаемости проекта, мес
    var srm = $("#srm-4");	//стоимость расходного материала
    var srm2 = $("#srm2-4");	//стоимость расходных материалов
    var kpp = $("#kpp-4");	//количество производимой продукции
    var dsp = $("#dsp-4");	//расходы связанные с производством
    var sebest = $("#sebest-4");	//себестоимость продукта
    var dobav = $("#dobav-4");	//добавленная стоимость
    var dohod = $("#dohod-4");	//доход с произведенной продукции
    ...
    function ClearAll() {
        $('#form4').find('input:text, input:password, input:file, textarea').val('');
        Calculate();
    };
    ...
    $("#reset-4").click(function () { ClearAll(); });
