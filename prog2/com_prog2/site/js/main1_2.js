$(document).ready(function (e) {
    var ed = $("#ed-1");	//ежемесяный доход
    var no = $("#no-1");	//налоговые отчисления
    var ap = $("#ap-1");	//арендная плата
    var svt = $("#svt-1");	//стоимость ввезенных товаров
    var zp = $("#zp-1");	//заработная плата работников
    var rt = $("#rt-1");	//расходы на транспортные услуги
    var pr = $("#pr-1");	//прочие расходы
    var pk = $("#pk-1");	//плата за комунальные услуги
    var pz = $("#pz-1");	//плата за кредит
    var itog1 = $("#itog1-1");	//чистая прибыль
    var nsm = $("#nsm-1");	//необходимая сумма на первый месяц
    var sums = $("#sums-1");	//общая сумма расходов
    var credit = $("#credit-1");	//кредит
    var ssn = $("#ssn-1");	//сумма средств в наличии
    var so = $("#so-1");	//стоимость оборудования
    var sr = $("#sr-1");	//стоимость рекламы
    var timeo = $("#timeo-1");	//срок окупаемости проекта, мес
    var srm = $("#srm-1");	//стоимость расходного материала
    var srm2 = $("#srm2-1");	//стоимость расходных материалов
    var kpp = $("#kpp-1");	//количество производимой продукции
    var dsp = $("#dsp-1");	//расходы связанные с производством
    var sebest = $("#sebest-1");	//себестоимость продукта
    var dobav = $("#dobav-1");	//добавленная стоимость
    var dohod = $("#dohod-1");	//доход с произведенной продукции
    ...
    function Calculate() {
        ...
        sum = s1i3 + s1i4 + s1i5 + s1i6 + s1i7 + s1i8 + s1i9 + s1i10;
    ...
    $("#reset-1").click(function () { ClearAll(); });
