$(document).ready(function (e) {
    var ed = $("#ed-2");	//ежемесяный доход
    var no = $("#no-2");	//налоговые отчисления
    var ap = $("#ap-2");	//арендная плата
    var svt = $("#svt-2");	//стоимость ввезенных товаров
    var zp = $("#zp-2");	//заработная плата работников
    var rt = $("#rt-2");	//расходы на транспортные услуги
    var pr = $("#pr-2");	//прочие расходы
    var pk = $("#pk-2");	//плата за комунальные услуги
    var pz = $("#pz-2");	//плата за кредит
    var itog1 = $("#itog1-2");	//чистая прибыль
    var nsm = $("#nsm-2");	//необходимая сумма на первый месяц
    var sums = $("#sums-2");	//общая сумма расходов
    var credit = $("#credit-2");	//кредит
    var ssn = $("#ssn-2");	//сумма средств в наличии
    var so = $("#so-2");	//стоимость оборудования
    var sr = $("#sr-2");	//стоимость рекламы
    var timeo = $("#timeo-2");	//срок окупаемости проекта, мес
    var srm = $("#srm-2");	//стоимость расходного материала
    var srm2 = $("#srm2-2");	//стоимость расходных материалов
    var kpp = $("#kpp-2");	//количество производимой продукции
    var dsp = $("#dsp-2");	//расходы связанные с производством
    var sebest = $("#sebest-2");	//себестоимость продукта
    var dobav = $("#dobav-2");	//добавленная стоимость
    var dohod = $("#dohod-2");	//доход с произведенной продукции
    ...
    $("#reset-2").click(function () { ClearAll(); });
